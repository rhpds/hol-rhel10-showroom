...
***  xref:spotlight-podman-100.adoc[Containers pt.1 (podman)]
***  xref:spotlight-buildah-101.adoc[Containers pt.2 (buildah,skopeo)]
***  xref:spotlight-podman-200.adoc[Containers pt.3 (namespaces)]
