...
To access the Web Console, navigate to the "Cockpit" Tab:

====
image::rhel-10.0/wc-001.png[Cockpit Login,link=self,window=blank]
====

Then login with the following UserID and Password:
...
[NOTE]
====
The Service Selector Filter does allow searching for either "chrony" or "ntp" but when searching in the Firewall service, it only recognizes "ntp" and not "chrony".
====
