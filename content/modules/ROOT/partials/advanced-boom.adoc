...
Created profile with os_id f873854:
  OS ID: "f873854866dc81804d3ccd62d8fbf66e9a56f749",
  Name: "Red Hat Enterprise Linux", Short name: "rhel",
  Version: "10.1 (Coughlan)", Version ID: "10.1",
  Kernel pattern: "/boot/vmlinuz-%{version}", Initramfs pattern: "/boot/initramfs-%{version}.img",
  Root options (LVM2): "rd.lvm.lv=%{lvm_root_lv}",
  Root options (BTRFS): "rootflags=%{btrfs_subvolume}",
  Options: "root=%{root_device} ro %{root_opts} console=tty0 console=ttyS0,115200n8 crashkernel=2G-64G:256M,64G-:512M",
...
[{format_cmd}]
----
boom profile list --osversion "10.1 (Coughlan)"
----

[{format_output}]
----
OsID    Name                     OsVersion
f873854 Red Hat Enterprise Linux 10.1 (Coughlan)
----
...
[{format_cmd}]
----
boom profile show --osversion "10.1 (Coughlan)"
----

[{format_plain}]
----
OS Profile (os_id=f873854)
  OS ID: "f873854866dc81804d3ccd62d8fbf66e9a56f749",
  Name: "Red Hat Enterprise Linux", Short name: "rhel",
  Version: "10.1 (Coughlan)", Version ID: "10.1",
  ...
  Root options (LVM2): "rd.lvm.lv=%{lvm_root_lv}",
  Root options (BTRFS): "rootflags=%{btrfs_subvolume}",
  Options: "root=%{root_device} ro %{root_opts} nofb quiet splash=quiet crashkernel=2G-64G:256M,64G-:512M resume=UUID=508a49d7-3737-4564-9007-37ae9544196a rd.lvm.lv=rhel_node3/swap",
  Title: "%{os_name} %{os_version_id} (%{version})",
  Optional keys: "grub_users grub_arg grub_class id", UTS release pattern: "el10"
----
...
51050b0 6.12.0-124.8.1.el10_1.x86_64  Red Hat Enterprise Linux UUID=005ed5b0-a961-4598-8ff0-7fe34746b598
2a7cdc5 6.12.0-124.45.1.el10_1.x86_64 Red Hat Enterprise Linux UUID=005ed5b0-a961-4598-8ff0-7fe34746b598
----
...
[{format_plain}]
----
Boot Entry (boot_id=51050b0)
  title Red Hat Enterprise Linux (6.12.0-124.8.1.el10_1.x86_64) 10.1 (Coughlan)
  version 6.12.0-124.8.1.el10_1.x86_64
  linux /boot/vmlinuz-6.12.0-124.8.1.el10_1.x86_64
  initrd /boot/initramfs-6.12.0-124.8.1.el10_1.x86_64.img $tuned_initrd
  options root=UUID=005ed5b0-a961-4598-8ff0-7fe34746b598 console=tty0 console=ttyS0,115200n8 crashkernel=2G-64G:256M,64G-:512M $tuned_params
  grub_users $grub_users
  grub_arg --unrestricted
  grub_class rhel

Boot Entry (boot_id=2a7cdc5)
  title Red Hat Enterprise Linux (6.12.0-124.45.1.el10_1.x86_64) 10.1 (Coughlan)
  version 6.12.0-124.45.1.el10_1.x86_64
  linux /boot/vmlinuz-6.12.0-124.45.1.el10_1.x86_64
  initrd /boot/initramfs-6.12.0-124.45.1.el10_1.x86_64.img $tuned_initrd
  options root=UUID=005ed5b0-a961-4598-8ff0-7fe34746b598 console=tty0 console=ttyS0,115200n8 crashkernel=2G-64G:256M,64G-:512M $tuned_params
  grub_users $grub_users
  grub_arg --unrestricted
  grub_class rhel
...
[{format_plain}]
----
BOOT_IMAGE=(hd0,gpt3)/boot/vmlinuz-6.12.0-124.45.1.el10_1.x86_64 root=UUID=005ed5b0-a961-4598-8ff0-7fe34746b598 console=tty0 console=ttyS0,115200n8 crashkernel=2G-64G:256M,64G-:512M
----
...
[{format_plain}]
----
root=UUID=005ed5b0-a961-4598-8ff0-7fe34746b598
----
...
Created entry with boot_id 311e1df:
  title RHEL 10 Workshop
  machine-id bb4474455884547b827b42318a4ad54a
  version 6.12.0-124.45.1.el10_1.x86_64
  linux /boot/vmlinuz-6.12.0-124.45.1.el10_1.x86_64
  initrd /boot/initramfs-6.12.0-124.45.1.el10_1.x86_64.img
  options root=/dev/vda3 ro console=tty0 console=ttyS0,115200n8 crashkernel=2G-64G:256M,64G-:512M
  grub_users $grub_users
  grub_arg --unrestricted
  grub_class kernel
----
...
51050b0 6.12.0-124.8.1.el10_1.x86_64  Red Hat Enterprise Linux UUID=005ed5b0-a961-4598-8ff0-7fe34746b598
2a7cdc5 6.12.0-124.45.1.el10_1.x86_64 Red Hat Enterprise Linux UUID=005ed5b0-a961-4598-8ff0-7fe34746b598
311e1df 6.12.0-124.45.1.el10_1.x86_64 Red Hat Enterprise Linux /dev/vda3
----
...
Created entry with boot_id be46a41:
  title RHEL 10 Workshop
  machine-id bb4474455884547b827b42318a4ad54a
  version 6.12.0-124.45.1.el10_1.x86_64
  linux /boot/vmlinuz-6.12.0-124.45.1.el10_1.x86_64
  initrd /boot/initramfs-6.12.0-124.45.1.el10_1.x86_64.img
  options root=/dev/vda3 ro console=tty0 console=ttyS0,115200n8 crashkernel=2G-64G:256M,64G-:512M custom_value=true
  grub_users $grub_users
  grub_arg --unrestricted
  grub_class kernel
----
...
[{format_output}]
----
     0  title="Red Hat Enterprise Linux (6.12.0-124.8.1.el10_1.x86_64) 10.1 (Coughlan)"
     1  title="RHEL 10 Workshop"
     2  title="Red Hat Enterprise Linux (6.12.0-124.45.1.el10_1.x86_64) 10.1 (Coughlan)"
----
...
----
index=1
kernel="/boot/vmlinuz-6.12.0-124.45.1.el10_1.x86_64"
args="ro console=tty0 console=ttyS0,115200n8 crashkernel=2G-64G:256M,64G-:512M custom_value=true"
root="/dev/vda3"
initrd="/boot/initramfs-6.12.0-124.45.1.el10_1.x86_64.img"
title="RHEL 10 Workshop"
id="bb4474455884547b827b42318a4ad54a-be46a41-6.12.0-124.45.1.el10_1.x86_64"
----
...
Confirm that the custom_value key is now part of the kernel boot options.
