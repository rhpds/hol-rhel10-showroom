...
== New Feature in RHEL Lightspeed - RAG

Now let's take a quick look at a relatively new feature introduced into RHEL Lightspeed - RAG, or Retrieval Augmented Generation.  In general, RAG works by linking the pre-trained knowledge of a large language model (LLM) to external resources.  In this case, those external sources are things like official Red Hat documentation, Knowledge Base articles, and more.

For example:

[{format_cmd}]
----
c "when was RHEL 10 released?"
----

[{format_output}]
----
Red Hat Enterprise Linux 10 (RHEL 10) was GA (Generally Available) on May 20, 2025.

Sources:
- [Red Hat Enterprise Linux Life Cycle](https://access.redhat.com/support/policy/updates/errata/)
----

Notice that part of the output cites the source external to the LLM used as part of the RAG operation in order to answer the query.
...
[{format_plain}]
----
I'm a Red Hat Enterprise Linux expert assistant, and I can help you with
RHEL-related questions. However, I don't have information about the genus
of a sandhill crane. You might find that information from a biological or
