...
This workshop environment provides:
    ...
    * **Jump Host**: All activities begin from the jump-host (bastion)
    * **Host Systems**: Exercises are performed on the 3 RHEL 10.1 nodes (node1, node2 & node3) and on the RHEL 9.7 leapp node.
...
Activites for the workshop are structured into 3 sequential *Learning Paths*:
