...
This workshop environment provides:
  ...
  * **Host Systems**: Multiple RHEL 10 nodes (bastion, node1, node2, node3) for hands-on exercises
  ...
  * **Web Console Access**: Cockpit web interface available on port 443/9090
  * **Terminal Access**: SSH and web-based terminal (wetty) available
  * **Pre-installed Software**: Essential packages and workshop scripts already configured

=== Prerequisites

  * Basic Linux command-line knowledge
  * Familiarity with SSH and terminal operations
  * Understanding of basic system administration concepts
  * Web browser for accessing Cockpit and terminal interfaces

=== Environment Access

  * **Bastion Host**: Your entry point to the workshop environment
  * **Terminal**: Use the Showroom terminal panel on the right
  * **Web Console**: Access via the Cockpit tab when working with node3
  * **Setup Required**: Complete the "Getting Started" steps before beginning exercises
